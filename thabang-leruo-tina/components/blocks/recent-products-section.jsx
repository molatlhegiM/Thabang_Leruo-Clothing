"use client";
// Recent Products Section for Homepage
import React, { useEffect } from "react";
import { recentProductsData } from "./recentProductsData";

const RecentProductsSection = ({ data }) => {
  const products = data?.products || recentProductsData;
  const title = data?.title || "Recent Products";
  const subtitle = data?.subtitle || "Check out our latest arrivals";
